...
var _index = require('./prettier/index');
...
var TransformUmbrella = function () {
  ...
  TransformUmbrella.prototype.use = function use(t, options) {
    this.transformers.push([t, options]);
    return this;
  };

  TransformUmbrella.prototype.format = function format(schema, formatter) {
    ...
    pReduce(this.transformers, function (schemaPath, _ref) {
      ...
      if (options.pretty && typeof output === 'string') {
        output = (0, _index2.default)(output, options.prettyOptions);
      }
